...
- `b206ad6` 2026-08-07 — 研究课题 Phase 1（续）：检查点台账 + 统一到期查询 + BofA 入库 (#4)
- `1a8c6e1` 2026-08-07 — 研究课题 Phase 1：分析师档案库 registry.jsonl + 加载器 (#3)
- `366221d` 2026-08-07 — 达利欧泡沫模型 + 分析师板块扩容 + 三体制模型说明 + 研究课题立项 (#2)
