...
- `7f74d55` 2026-08-02 — feat(news): 周日例外——放宽到最近3天,其余严格当天
- `01d1785` 2026-08-02 — fix(news): 严格「当天」+ 每类10条 + 去重(按 Rachel 要求)
- `cc0a58b` 2026-08-02 — feat: 每类新闻凑够10条 + 抓取时间戳(网页/微信对齐)
