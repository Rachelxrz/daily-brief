...
- `7f1c013` 2026-08-07 — macro_gate intraday refresh 2026-08-07 00:39Z
- `264f86d` 2026-08-06 — watchlist:把系统规则写入 watchlist.json 的 spec 节 + 记入 CHANGELOG
- `ea64459` 2026-08-06 — 用QQQ替代低效稳定核心:3年跑不过QQQ→移入Secondary(标注3年回报低于QQQ)
- `07632cd` 2026-08-06 — 分档:稳定核心加低波动闸门(≤45%),波动型非成长(TSLA/CIEN)归趋势成长
- `02b2064` 2026-08-06 — 个股基本面分档:写入watchlist + 每半年复核 + 均线页分档徽章
- `3ac3786` 2026-08-06 — Secondary 移出闸门 周线200MA → 150MA + 迁回已站上150的标的
- `2f9b7c9` 2026-08-06 — Secondary Watchlist:正式命名 + 回归复查改为每周一次
- `23b062b` 2026-08-06 — data: watchlist 变更日志追加当日筛选写入事件
- `cc263cf` 2026-08-06 — 强势股筛选:新增基础条件「周线价格>120周MA」
- `8c2879e` 2026-08-06 — watchlist:周线200MA暂停/恢复闸门 + 来源标记 + 每日变更日志
- `651a420` 2026-08-06 — 强势股筛选:排序改为6月最小波动 + 入选股自动写入watchlist并跟踪均线
- `4f821a6` 2026-08-06 — 强势股筛选:移除自选股技术分析(与均线页重复)+ 拆分潜在/现有强势股
