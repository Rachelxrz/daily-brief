...
- `13584cb` 2026-08-09 — backtest_models 历史回测刷新 2026-08-09 00:37Z
- `7ded154` 2026-08-08 — Phase 3 续:四模型历史重算+回测 backtest_models.py + 月度 workflow (#10)
- `a8799f4` 2026-08-08 — 研究底稿:补全各模型「怎么算」附录(双语) (#9)
- `b501a57` 2026-08-08 — Phase 3 回测引擎 backtest.py（+ 解决线上无数据 #1） (#7)
- `179081c` 2026-08-08 — 研究底稿:观点→模型 建模论证(双语) (#8)
