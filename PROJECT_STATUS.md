...
- `5e7e0fc` 2026-08-09 — 导航标签 WSJ 风格:衬线加粗、近黑文字、米白底色 (#15)
- `34c84be` 2026-08-09 — 网页改浅色主题:背景白 / 正文黑,强调色不变 (#13)
- `29b9553` 2026-08-09 — 对齐发布滞后口径的真实数字(承接 PR#12 无前视修正) (#14)
- `dc95b53` 2026-08-09 — backtest+crisis 历史回测刷新 2026-08-09 15:03Z
- `bf9e27d` 2026-08-09 — view_to_model 增实证章(历史回测+危机前30天)+ CHANGELOG (#12)
- `bb10304` 2026-08-09 — backtest+crisis 历史回测刷新 2026-08-09 14:38Z
- `58ae129` 2026-08-09 — Phase 3 续②:危机前30天轨迹 + 回测记分卡网页 + 校准结论 (#11)
