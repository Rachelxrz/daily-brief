...
**自动刷新时间**：2026-06-30 05:50 CST
**data.json 今日更新**：2026-06-30 01:20 CST
...
- `3c24f3a` 2026-06-29 — fix: 技术信号tab自动跳转到最近有数据的交易日
- `a8de05c` 2026-06-29 — fix: 修复普通新闻中文翻译失败（Claude 速率限制）
