...
### 方法论深化（2026-08-07 调研落地）
- [x] 分档标签校准到达利欧百分位锚点（1929/2000≈100、2021≈77、2024≈52）
- [x] 新增**供给针**（IPO ETF 6 月分位 ≥85 代理）与货币针并列，判读/面板显示双针
- [x] 新增**领先对早期预警**（表3新买家+表4情绪 同 ≥0.75）：综合未偏高也提示，判读转黄
- [x] note 标注「等权均值仅为其多指标百分位合成的**近似**」
- [x] 合成测试新增「供给针单独触发」「发行冷→melt-up 无针」两场景
